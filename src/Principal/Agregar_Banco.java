 ...
 * 
 */
public class Agregar_Banco extends javax.swing.JFrame {
...
Banco.Agregar_Banco(Nombre, Direccion);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agregar_Banco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Agregar_Banco().setVisible(true);
            }
        });
    }
